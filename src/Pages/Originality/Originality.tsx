      ...
      <main id="main-content" className="originality">
        ...
        >
          ...
          <div>
            ...
            <Typography variant="body">
              Assessors get a full originality view in context — without leaving
              your system.
            </Typography>
          </div>
          <div>
        ...
        >
          ...
          <blockquote>
            <Typography variant="body">
              "Seamless LMS integration and strong academic integrity – exactly
              what we needed."
            </Typography>
            <footer>
              <Typography variant="body">
        ...
        >
          ...
          <div className="card">
            ...
            <Typography variant="body">
              Explore why students plagiarise – and how educators can act early
              to prevent it.
            </Typography>
          ...
          <div className="card">
            <Typography variant="h4">5 Smart Tips to Stay Original</Typography>
            <Typography variant="body">
              Avoid plagiarism with student-approved strategies. From citing to
